...
#experiment.add_observations("total_chlorophyll", "Exp_OC_HT_P_HE_FC.dat")
#experiment.add_observations("total_chlorophyll", "Exp_OC_HT_P_LE_FC.dat")
experiment.add_observations("P1_Chl[-1]", "../observations/P1_Chl_cci_5d.dat")
#experiment.add_observations("total_chlorophyll", "Exp_OC_HT.dat")
